...
def records(request):
  ...
  sales_df=None  #initialize dataframe and chart to None
  chart = None

  #check if the button is clicked
  if request.method =='POST':
    #read book_title and chart type
    ...
    if qs:  #if data found
      #convert queryser values to pandas dataframe
  ...
  #load the sales/record.htnl page using data just prepared
